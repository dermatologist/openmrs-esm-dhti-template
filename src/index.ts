...
// const moduleName = '@openmrs/esm-dhti-template';
...
// export const DhtiTemplateLeftPanelLink = getSyncLifecycle(createDashboardLink(dashboardMeta), options);
...
// export const DhtiTemplateLeftPanelLink = getAsyncLifecycle(ConversationContainer, options);
